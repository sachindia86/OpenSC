...
MD_REGISTRATION minidriver_registration[] = {
    {TEXT("AmbiSecureDS"),                    {0x3b,0xd5,0x18,0xff,0x81,0x91,0xfe,0x1f,0xc3,0x80,0x73,0xc8,0x21,0x10,0x0a},
                                          15, {0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff}},
    {TEXT("AmbiSecureDS"),                    {0x3b,0xd5,0x18,0xff,0x81,0x91,0xfe,0x1f,0xc3,0xae,0x19,0x04,0x82,0x00,0x31},
                                          15, {0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff}},
...
VOID RegisterSmartCard(PMD_REGISTRATION registration)
{
    ...
    DWORD i;
    PTSTR szPath = TEXT("C:\\OpenSC\\opensc-minidriver.dll");

    /* cope with x86 installation on x64 */
    expanded_len = ExpandEnvironmentStrings(
            TEXT("C:\\OpenSC\\opensc-minidriver.dll"),
